...
contract MoodNftTest is Test {
    ...
    string private constant SAD_SVF_URI =
    ...
    function setUp() public {
        moodNft = new MoodNft(SAD_SVF_URI, HAPPY_SVG_URI);
    }
    ...
    function testFlipMood() public minted {
        vm.prank(USER);
        moodNft.flipMood(0);
        assert(moodNft.getMood(0) == MoodNft.Mood.SAD);
    }

    function testFlipMoodRevertsIfNotOwner() public minted {
        vm.prank(USER2);
